...
public class Payment {
	...
	public String toString() {
		return "Payment [email=" + email + ", merchantRefNum=" + merchantRefNum + ", amount=" + amount
				+ ", currencyCode=" + currencyCode + ", dupCheck=" + dupCheck + ", settleWithAuth=" + settleWithAuth
